...
router.get('/inventory/lookup/search', verifyToken, inventoryService.searchProductsForLookup);
router.get('/inventory/lookup/:productId', verifyToken, inventoryService.getProductInventoryDetail);

// Dashboard routes
router.get('/dashboard/overview', verifyToken, dashboardService.getOverview);
router.get('/dashboard/stats', verifyToken, validateQuery(dashboardQuerySchema), dashboardService.getStats);
router.get('/dashboard/revenue-chart', verifyToken, validateQuery(dashboardQuerySchema), dashboardService.getRevenueChart);
router.get('/dashboard/top-products', verifyToken, validateQuery(dashboardQuerySchema), dashboardService.getTopProducts);
router.get('/dashboard/sales-channels', verifyToken, validateQuery(dashboardQuerySchema), dashboardService.getSalesChannels);
router.get('/dashboard/top-customers', verifyToken, validateQuery(dashboardQuerySchema), dashboardService.getTopCustomers);
router.get('/dashboard/low-stock', verifyToken, validateQuery(dashboardQuerySchema), dashboardService.getLowStock);
